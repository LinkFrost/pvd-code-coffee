export const organizers = [
  {
    ...
    role: "Lead Organizer",
    image:
      "https://k3ss83nfoe.ufs.sh/f/SkDqcSrWrmeXD5MKuCVutzqdrmnZw6UXbyS1V0JMcoQ9NCGT",
  ...
  },
  {
    ...
    image:
      "https://k3ss83nfoe.ufs.sh/f/SkDqcSrWrmeXdDI2ewrlLFkRvPhT3mIAK2UNEWdMf6x5aczb",
    ...
    links: {
      ...
      linkedIn: "https://github.com/LinkFrost",
...
export const eventStructureSteps = [
  ...
  {
    stepName: "Featured Presentation",
    details:
  ...
  {
    stepName: "Additional Presentations & Showcases",
    details:
  ...
  {
    stepName: "Socializing & Networking",
    details:
